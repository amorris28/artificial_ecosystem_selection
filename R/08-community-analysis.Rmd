...
save(kt, wt, rare_median, s5, min_seqs, file = "Output/richness_models.RData")
...
ggsave('Manuscript/fig3.png', p_beta, height = 2.5, width = 4) 

ggsave('Manuscript/fig3.svg', p_beta, height = 2.5, width = 4) 
...
if(file.exists("Output/rare_dist_bray_p5.rds")) {
  rare_dist_bray_p5 <- 
    readRDS("Output/rare_dist_bray_p5.rds")
} else {
rare_dist_bray_p5 <- avgdist(passage5_df, dmethod="bray", sample=seq_range[1])
  rare_dist_bray_p5 %>% 
    saveRDS("Output/rare_dist_bray_p5.rds")
}
...
save(dbrda_aov, dbrda_percent_explained, file = "Output/dbrda.RData")
...
ggsave('Manuscript/fig4.svg', p_log10, width = 5, height = 5) 
