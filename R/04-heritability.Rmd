...
This script imports the heritability data. This dataset includes the mean flux withn treatment*generation for 1) all parents, 2) selected parents, and 3) offspring. Then, it plots offspring on the selection parents with the two treatments combined and then separately for the two treatments.
