...
plot_flux <- function(fluxes, passage, estimate) {
...
plot_log_flux <- function(fluxes, passage, estimate_log10) {
...
plot_flux(fluxes, passage, estimate)

#ggsave('fluxes_raw.pdf', width = 5, height = 4)

```

## 3. Plot the log-transformed data
...
plot_log_flux(fluxes, passage, estimate_log10)
